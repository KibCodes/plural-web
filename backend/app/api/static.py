...
# Sitemap
Sitemap: https://system.kib.lol/sitemap.xml
"""
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
  ...
  <!-- Admin/Login Pages -->
  <url>
    <loc>https://system.kib.lol/admin/login</loc>
    <lastmod>{datetime.now(timezone.utc).strftime('%Y-%m-%d')}</lastmod>
...
"""
  ...
  <url>
    <loc>https://system.kib.lol/{member_name}</loc>
    <lastmod>{datetime.now(timezone.utc).strftime('%Y-%m-%d')}</lastmod>
    ...
    try:
        ...
        for member in members:
            ...
            members_structured.append({
                ...
                "name": member_name,
                "image": member_avatar,
                "url": f"https://system.kib.lol/{member_url_name}",
...
<head>
    ...
    <meta property="og:url" content="https://system.kib.lol/fronting" />
    {structured_data}
</head>
"""
...
async def serve_member_page(member_name: str, request: Request):
    ...
    {{
      ...
      "description": "{description}",
      "image": "{avatar_url}",
      "url": "https://system.kib.lol/{member_name}",
...
<head>
    ...
    <meta property="og:url" content="https://system.kib.lol/{member_name}" />
    {structured_data}
</head>
"""
